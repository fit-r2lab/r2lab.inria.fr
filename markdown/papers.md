title: Publications related to R2lab
tab: papers
...
* Rossella Franco (PFE Ubinet 2019-20) on Enhancing Geolocation with Circular Antenna Arrays in LoRa Low Power Wide Area Network.
...
* Castanheira, Tiago & Silva, Joaquim & Marques, Eduardo & Lopes, Luis, [Simulation of mobile edge-cloud applications using Mininet-WiFi](https://www.researchgate.net/profile/Eduardo_Marques11/publication/327467763_Simulation_of_mobile_edge-cloud_applications_using_Mininet-WiFi/links/5b90fc8a299bf114b7ff02ee/Simulation-of-mobile-edge-cloud-applications-using-Mininet-WiFi.pdf), in [INForum'18](http://inforum.org.pt/INForum2018/programa/programa.html), University of Comibra, Portugal, 2018. 
...
* Tiago Miguel Alves Castanheira, [Simulation of mobile edge-cloud applications using Mininet-WiFi](https://repositorio-aberto.up.pt/bitstream/10216/118829/2/312178.pdf), Master thesis, University of Porto.
* Cevallos Sánchez, Liseth Paulina, [Implementation of Software Defined Networks (SDN) over IEEE 802.11 networks using MININET WI-FI
](http://dspace.espoch.edu.ec/bitstream/123456789/9144/8/98T00197.pdf), Chimborazo Higher Polytechnic School. Riobamba.
...
* Mahfoudi, M. N., Turletti, T., Parmentelat, T., Ferrero, F., Lizzi, L., Staraj, R., & Dabbous, W. (2017, May). [FAR CA: Orientation estimation using commodity Wi-Fi](https://hal.archives-ouvertes.fr/hal-01424239). In Communications Workshops (ICC Workshops), 2017 IEEE International Conference on (pp. 1233-1238). IEEE.
...
* Pakzad, Farzaneh (2017). [Towards Software Defined Wireless Mesh Networks](https://espace.library.uq.edu.au/data/UQ_686095/s4296167_phd_thesis.pdf?dsi_version=63ac1ced11381ba14546bc1603a4d6f5&Expires=1613073248&Key-Pair-Id=APKAJKNBJ4MJBJNC6NLQ&Signature=GBFruPtHB6~qSIE1RzJoTTgThlcNIlWgDCw2ME1WMTNdcCxiHSFNj0CXQY-RkhD4ookqP86Ln4ebbIWwfs2cj1~fIXTnGjlwX0XYn4TNst8P-a5BB0rcLGdpxFBcJ2El-LLxYu5D9UJIwCKioC7F0afJGHQOSDeWQiWWthv0bF9i560fv7DrpNZueMXDuttoAnypLiN31wQh9Z7RPs6fGJY44vQ-TkLcB8g79qa2vmS1yBXtVwrMV-eGeS2X2E-Dxh~L4iy~A5Pvpm2ZJbIbDzjvWe7XVlmvlSIthNJVsLeODwuYcZ54patRoqPGiJVrEGKZDHO8OWWf1ITca4MZ4g__). PhD Thesis, School of Information Technol and Elec Engineering, The University of Queensland.
...
* Ramon dos Reis Fontes and Christian Esteve Rothenberg. [Mininet-WiFi: A Platform for Hybrid Physical-Virtual Software-Defined Wireless Networking Research](https://doi.org/10.1145/2934872.2959070), in Proceedings of the 2016 ACM SIGCOMM Conference (SIGCOMM '16). Association for Computing Machinery, New York, NY, USA, 607–608.
